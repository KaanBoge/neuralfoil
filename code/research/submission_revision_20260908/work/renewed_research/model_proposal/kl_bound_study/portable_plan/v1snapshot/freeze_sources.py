...
def main():
    ...
    names=['PLAN.md','README.md','COMPLETED_REVIEW_NOTE.md','integrity.py','export_support.py','shared.py','build_replay.py','replay.py','test_portable.py','test_source_adapter.py','freeze_sources.py','SOURCE_HANDOFF.md']
