...
STAGE0_REFS=['unpenalized_transfer','half_strength','proper_capped_half','qualified_matched_half',OLD_H[1],OLD_H[0],OLD_KL[1]]
OLD_REFS=STAGE0_REFS+[OLD_KL[0],PAIRED[0]]
REFS=OLD_REFS+[PAIRED[1]]
