...
class Tests(unittest.TestCase):
    ...
    def test_legitimate_conda_receipts_not_environment_trees(self):
        for name in ['conda_closure.json','conda_create.json','conda_create.log']:
            p.permitted('evidence/environment/'+name)
        for name in ['conda_forward/payload.json','venv_fit/payload.json','cache/payload.json']:
            with self.assertRaises(ValueError):p.permitted('evidence/environment/'+name)
