...
def format_doc(doc,kind,pages):
    ...
    for p in list(doc.paragraphs):
        ...
        if p.style.name.startswith('Heading'):
            ...
            if text=='References':pf.page_break_before=True;inrefs=True
...
def main():
    ...
    subprocess.run(['/opt/anaconda3/bin/pandoc',str(source),'--from','markdown+tex_math_dollars+tex_math_single_backslash+pipe_tables+autolink_bare_uris',
